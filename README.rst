...
----------------
1. Install Puput and its dependencies :code:`pip install puput`
2. Add :code:`puput`, :code:`wagtail.contrib.wagtailsitemaps' and :code:`wagtail.contrib.wagtailroutablepages` to your :code:`INSTALLED_APPS` in :code:`settings.py` file.
